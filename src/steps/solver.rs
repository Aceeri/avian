...
#[cfg(feature = "2d")]
fn compute_contact_vel(lin_vel: Vector, ang_vel: f64, r: Vector) -> Vector {
...
#[cfg(feature = "2d")]
fn compute_delta_ang_vel(inv_inertia: f64, r: Vector, p: Vector) -> f64 {
    inv_inertia * r.perp_dot(p)
}

#[cfg(feature = "3d")]
fn compute_delta_ang_vel(inv_inertia: DMat3, r: Vector, p: Vector) -> Vector {
