...
impl Joint for SphericalJoint {
    fn new_with_compliance(entity1: Entity, entity2: Entity, compliance: f64) -> Self {
        Self {
            ...
            swing_torque: 0.0,
            #[cfg(feature = "3d")]
            swing_torque: DVec3::ZERO,
            #[cfg(feature = "2d")]
            twist_torque: 0.0,
            #[cfg(feature = "3d")]
            twist_torque: DVec3::ZERO,
        }
    }
...
impl SphericalJoint {
    pub fn with_swing_limits(self, min: f64, max: f64) -> Self {
        Self {
    ...
    #[cfg(feature = "3d")]
    pub fn with_twist_limits(self, min: f64, max: f64) -> Self {
        Self {
    ...
    fn apply_angle_limits(
        ...
        if let Some(twist_limit) = self.twist_limit {
            ...
            if n_magnitude > f64::EPSILON {
                ...
                if n1_magnitude > f64::EPSILON && n2_magnitude > f64::EPSILON {
    ...
    fn update_swing_torque(&mut self, axis: DVec3, sub_dt: f64) {
        // Eq (17)
        #[cfg(feature = "2d")]
        {
    ...
    fn update_twist_torque(&mut self, axis: DVec3, sub_dt: f64) {
        // Eq (17)
        #[cfg(feature = "2d")]
        {
